                ...
                <div class="card bg-light mb-3" style="border-radius: 1rem;">
                    <div class="card-body p-5 text-center">
                        <div class="mb-md-5 mt-md-4 pb-5">
                            <h2 class="fw-bold mb-2">Registrarse</h2>
                        ...
                        <form method="post" action="../../Controller/userController.php?action=register">
                            <input type="text" id="nombre_usuario" name="nombre_usuario" class="form-control form-control-lg" placeholder="Usuario"/>
                        </div>
                        <div class="form-outline form-black mb-4">
                            <input type="password" id="passwd" name="passwd" class="form-control form-control-lg" placeholder="Contraseña"/>
                        </div>
                        <input class="btn btn-outline-dark btn-lg px-5" type="submit" value="Registrarse">
                        </form>
                    </div>
                    <p class="mb-0">¿Ya te has registrado? <a href="login.php" class="text-black-50 fw-bold">Inicia sesión</a></p>
                </div>
            </div>
        </div>
    </div>
